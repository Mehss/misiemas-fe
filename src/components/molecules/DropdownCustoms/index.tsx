...
const Dropdown = ({ data, placeholder, handleDropdown, isSite } : { data?: any, placeholder?: string, handleDropdown?: any, isSite?: boolean}) => {
  const [anchorEl, setAnchorEl] = React.useState<null | HTMLElement>(null)
  const open = Boolean(anchorEl)
  const [selected, setSelected] = React.useState(isSite ? 'Site Erection' : null)
