...
const DropdownCustom = ({ data, placeholder, handleDropdown, currSelected } : { data?: any, placeholder?: string, handleDropdown?: any, isSite?: boolean, isWorkcat?: boolean, currSelected?: string }) => {
  ...
  return (
    <div style={{ display: 'inline-block' }}>
      ...
      >
        ...
        {currSelected ? currSelected : placeholder}
      </Button>
      <StyledMenu
